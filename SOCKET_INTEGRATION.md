...
export const OrdersDashboard = () => {
  ...
  return <div>{/* Your orders list UI */}</div>;
};
```
...
export const PaymentButton = ({ orderId }) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showNotification({
          ...
          message:
            "Your payment has been sent. Waiting for blockchain confirmation...",
  ...
  return (
    <button onClick={handlePayment} disabled={isPaying || waitingConfirmation}>
